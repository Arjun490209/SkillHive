...
const AllCourses = () => {
  ...
  useEffect(() => {
    ...
    if (category.length > 0) {
      list = list.filter((course) => category.includes(course.category));
    }
    ...
    <div className="min-h-screen w-full bg-gray-50">
      ...
      <div className="flex pt-16 min-h-[calc(100vh-64px)]">
        ...
        >
          ...
          <button
            className="flex items-center gap-2 bg-white text-black px-4 py-2 rounded-lg font-medium hover:bg-gray-200 transition mb-6 w-full justify-center mt-8 lg:mt-0"
            onClick={() => {
        ...
        <main className="flex-1 flex flex-col">
          ...
          <div className="flex items-center gap-3 p-4 sm:p-6 bg-gray-50 border-b">
            ...
            <h2 className="text-xl sm:text-2xl font-semibold">All Courses</h2>
          </div>

          {/* COURSES */}
          <div className="flex-1 overflow-y-auto p-4 sm:p-6">
            <div className="mx-auto max-w-7xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 place-items-center lg:place-items-start">
