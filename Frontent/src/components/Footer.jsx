    ...
    <div className=' bg-black text-gray-300 py-10 px-6'>
      <div className='max-w-7xl mx-auto flex lg:items-center items-start justify-center gap-10 lg:gap-[150px] flex-col lg:flex-row'>
        <div className='lg:w-[40%] md:w-[50%] w-full'>
          <img src={logo} alt="logo" className='h-10 mb-3 border rounded-[5px]' />
          <h2 className='text-xl font-bold text-white mb-3'>SkillHive</h2>
        ...
        <div className='lg:w-[30%] md:w-full'>
          <div className='text-white font-semibold mb-2'>Quick Link</div>
          <ul className='text-sm space-y-1'>
            <li className='hover:text-white cursor-pointer' onClick={()=>navigate('/')}>Home</li>
            <li className='hover:text-white cursor-pointer' onClick={()=>navigate('/all-courses')}>All Course</li>
        ...
        <div className='lg:w-[30%] md:w-full'>
          <div className='text-white font-semibold mb-2'>All Categories</div>
          <ul className='text-sm space-y-1'>
